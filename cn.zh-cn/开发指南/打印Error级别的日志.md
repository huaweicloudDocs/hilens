# 打印Error级别的日志<a name="hilens_05_0052"></a>
...
-   **参数说明**
    ...
    **表 1**  参数说明
    ...
    <td class="cellrowborder" valign="top" width="47.71%" headers="mcps1.2.5.1.4 "><p id="zh-cn_topic_0174991595_p3765132681314"><a name="zh-cn_topic_0174991595_p3765132681314"></a><a name="zh-cn_topic_0174991595_p3765132681314"></a>Error级别的日志信息。单条日志支持最大255个字符。</p>
    </td>
    </tr>
    </tbody>
    </table>
