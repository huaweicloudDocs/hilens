...
-   由于Huawei HiLens服务依赖其他服务，所以需要在开始使用Huawei HiLens前获得相关服务的权限，包含ModelArts、OBS和VIS服务，Huawei HiLens与相关服务的关系请参见[与其它服务的关系](https://support.huaweicloud.com/productdesc-hilens/hilens_01_0006.html)。
...
<td class="cellrowborder" valign="top" width="38.25%" headers="mcps1.2.4.1.3 "><p id="p6834323151014"><a name="p6834323151014"></a><a name="p6834323151014"></a><a href="HiLens-Kit简介.md">HiLens Kit简介</a></p>
<p id="p1239614132062"><a name="p1239614132062"></a><a name="p1239614132062"></a><a href="步骤1-使用SSH连接到HiLens-Kit.md">步骤1：使用SSH连接到HiLens Kit</a></p>
<p id="p1043451917617"><a name="p1043451917617"></a><a name="p1043451917617"></a><a href="步骤2-HiLens-Kit组网配置.md">步骤2：HiLens Kit组网配置</a></p>
<p id="p112889256614"><a name="p112889256614"></a><a name="p112889256614"></a><a href="步骤3-注册-Huawei-Kit设备.md">步骤3：注册 Huawei Kit设备</a></p>
</td>
</tr>
...
<table><thead align="left"><tr id="row42281837142419"><th class="cellrowborder" valign="top" width="20.217978202179783%" id="mcps1.2.4.1.1"><p id="p87801047162912"><a name="p87801047162912"></a><a name="p87801047162912"></a>流程</p>
</th>
<th class="cellrowborder" valign="top" width="50.804919508049196%" id="mcps1.2.4.1.2"><p id="p57801477294"><a name="p57801477294"></a><a name="p57801477294"></a>说明</p>
</th>
<th class="cellrowborder" valign="top" width="28.97710228977102%" id="mcps1.2.4.1.3"><p id="p1078084712920"><a name="p1078084712920"></a><a name="p1078084712920"></a>详细指导</p>
</th>
</tr>
</thead>
<tbody><tr id="row1228137142411"><td class="cellrowborder" valign="top" width="20.217978202179783%" headers="mcps1.2.4.1.1 "><p id="p1153913382819"><a name="p1153913382819"></a><a name="p1153913382819"></a>注册HiLens Kit</p>
</td>
<td class="cellrowborder" valign="top" width="50.804919508049196%" headers="mcps1.2.4.1.2 "><p id="p553914319280"><a name="p553914319280"></a><a name="p553914319280"></a>首先，连接您购买的HiLens Kit，并将<span id="text1753953112810"><a name="text1753953112810"></a><a name="text1753953112810"></a>HiLens Kit</span>注册到<span id="text17539123112815"><a name="text17539123112815"></a><a name="text17539123112815"></a>Huawei HiLens</span>平台，连接端侧与云侧。</p>
</td>
<td class="cellrowborder" valign="top" width="28.97710228977102%" headers="mcps1.2.4.1.3 "><p id="p1753919322811"><a name="p1753919322811"></a><a name="p1753919322811"></a><a href="HiLens-Kit简介.md">HiLens Kit简介</a></p>
<p id="p1553915372811"><a name="p1553915372811"></a><a name="p1553915372811"></a><a href="步骤1-使用SSH连接到HiLens-Kit.md">步骤1：使用SSH连接到HiLens Kit</a></p>
<p id="p12539732281"><a name="p12539732281"></a><a name="p12539732281"></a><a href="步骤2-HiLens-Kit组网配置.md">步骤2：HiLens Kit组网配置</a></p>
<p id="p15539153132813"><a name="p15539153132813"></a><a name="p15539153132813"></a><a href="步骤3-注册-Huawei-Kit设备.md">步骤3：注册 Huawei Kit设备</a></p>
</td>
</tr>
<tr id="row0228737202417"><td class="cellrowborder" rowspan="2" valign="top" width="20.217978202179783%" headers="mcps1.2.4.1.1 "><p id="p2078184782919"><a name="p2078184782919"></a><a name="p2078184782919"></a>开发技能</p>
</td>
<td class="cellrowborder" valign="top" width="50.804919508049196%" headers="mcps1.2.4.1.2 "><p id="p10414156927"><a name="p10414156927"></a><a name="p10414156927"></a><strong id="b5752956297"><a name="b5752956297"></a><a name="b5752956297"></a>使用技能模板新建技能</strong>：获取Huawei HiLens提供的技能模板（已经包含了算法模型和逻辑代码），快速新建技能。</p>
</td>
<td class="cellrowborder" valign="top" width="28.97710228977102%" headers="mcps1.2.4.1.3 "><p id="p545394815315"><a name="p545394815315"></a><a name="p545394815315"></a><a href="获取技能模板.md">获取技能模板</a></p>
...
<tr id="row5228163713241"><td class="cellrowborder" valign="top" width="20.217978202179783%" headers="mcps1.2.4.1.1 "><p id="p99091636271"><a name="p99091636271"></a><a name="p99091636271"></a>部署技能</p>
</td>
<td class="cellrowborder" valign="top" width="50.804919508049196%" headers="mcps1.2.4.1.2 "><p id="p11909183122716"><a name="p11909183122716"></a><a name="p11909183122716"></a>将技能部署到设备上，便于调试运行效果。</p>
</td>
<td class="cellrowborder" valign="top" width="28.97710228977102%" headers="mcps1.2.4.1.3 "><p id="p29091332272"><a name="p29091332272"></a><a name="p29091332272"></a><a href="部署和调试技能.md">部署和调试技能</a></p>
</td>
</tr>
<tr id="row11630782815"><td class="cellrowborder" valign="top" width="20.217978202179783%" headers="mcps1.2.4.1.1 "><p id="p1242517154283"><a name="p1242517154283"></a><a name="p1242517154283"></a>查看技能运行效果</p>
</td>
<td class="cellrowborder" valign="top" width="50.804919508049196%" headers="mcps1.2.4.1.2 "><p id="p1018043416204"><a name="p1018043416204"></a><a name="p1018043416204"></a>查看设备数据以及技能的运行效果。</p>
</td>
<td class="cellrowborder" valign="top" width="28.97710228977102%" headers="mcps1.2.4.1.3 "><p id="p10425615192811"><a name="p10425615192811"></a><a name="p10425615192811"></a><a href="管理数据.md">管理数据</a></p>
</td>
</tr>
<tr id="row294772391611"><td class="cellrowborder" valign="top" width="20.217978202179783%" headers="mcps1.2.4.1.1 "><p id="p65842323280"><a name="p65842323280"></a><a name="p65842323280"></a>发布至技能市场</p>
</td>
<td class="cellrowborder" valign="top" width="50.804919508049196%" headers="mcps1.2.4.1.2 "><p id="p694892318163"><a name="p694892318163"></a><a name="p694892318163"></a>将技能发布到技能市场，供用户安装使用。</p>
</td>
<td class="cellrowborder" valign="top" width="28.97710228977102%" headers="mcps1.2.4.1.3 "><p id="p11948122316169"><a name="p11948122316169"></a><a name="p11948122316169"></a><a href="发布至技能市场.md">发布至技能市场</a></p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="48.89%" headers="mcps1.2.4.1.2 "><p id="p2303104132010"><a name="p2303104132010"></a><a name="p2303104132010"></a>将订购的技能下发到设备上，供用户使用。</p>
</td>
...
<td class="cellrowborder" valign="top" width="56.67%" headers="mcps1.2.4.1.3 "><p id="p86561234134317"><a name="p86561234134317"></a><a name="p86561234134317"></a>对于开发者，你可以在Huawei HiLens平台新建您的技能，可以使用技能模板新建技能，或者自行开发算法模型和逻辑代码，再用于新建技能。另外，还支持将您开发的技能安装部署至设备进行调试。</p>
...
<td class="cellrowborder" valign="top" width="56.67%" headers="mcps1.2.4.1.3 "><p id="p8427113234818"><a name="p8427113234818"></a><a name="p8427113234818"></a>针对厂商（使用海思35XX系列芯片的设备厂商），您可以使用Huawei HiLens平台管理您的产品，同时订购相应的技能，将技能分发至产品设备中，使得您的设备产品具备AI能力。</p>
</td>
</tr>
</tbody>
</table>
